...
export default function AIMentor() {
  ...
  async function handleSendMessage() {
    ...
    try {
      ...
      const prompt = `You are an AI Mentor for graduate students learning AI and machine learning. You are powered by Google Gemini 2.5 Flash.
        ...
        <Card variant="premium" className="overflow-hidden">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-medium-gray text-lg mb-4">Powered by Google Gemini 2.5 Flash</p>
