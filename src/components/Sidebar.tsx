import { Home, BookOpen, Brain, Briefcase, Newspaper, MessageCircle, User, LayoutDashboard, Plus, Briefcase as BriefcaseIcon, Users, ArrowLeft, Settings, FolderKanban, Zap, Code, Target, Sparkles } from 'lucide-react';
...
export default function Sidebar({ isAdmin = false }: SidebarProps) {
  ...
  return (
    <motion.div
      ...
      className={`fixed left-0 top-0 h-screen w-72 overflow-y-auto custom-scrollbar ${
        isAdmin ? 'bg-cream-bg border-r border-light-accent' : 'bg-cream-bg border-r border-light-accent'
      } shadow-xl`}
    >
      <div className="p-6">
        {/* Logo Section */}
