import { Home, BookOpen, Brain, Briefcase, Newspaper, MessageCircle, User, LayoutDashboard, Plus, Briefcase as BriefcaseIcon, Users, ArrowLeft, Settings, FolderKanban, Zap, Code } from 'lucide-react';
